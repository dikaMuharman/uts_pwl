...
if (!empty($_POST['simpan'])) {
    ...
    if($status){
        header('Location:http://localhost/tugas-uts/index.php?hal=data-pegawai&status=success');
    } else {
        header('Location:http://localhost/tugas-uts/index.php?hal=data-pegawai&status=gagal');
    }
    ...
    if ($_SESSION['member']['role'] == "staff"){
        ...
        header('Location:http://localhost/tugas-uts/index.php?hal=data-pegawai');
    }
}else {
    header('Location:http://localhost/tugas-uts/index.php?hal=tambah-data');
}
